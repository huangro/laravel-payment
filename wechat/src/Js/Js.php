 ...
 */
namespace TYWeChat\Js;

use Doctrine\Common\Cache\Cache;
use Doctrine\Common\Cache\FilesystemCache;
use TYWeChat\Core\AbstractAPI;
use TYWeChat\Support\Str;
use TYWeChat\Support\Url as UrlHelper;
...
class Js extends AbstractAPI
{
     ...
     * Ticket cache prefix.
     */
    const TICKET_CACHE_PREFIX = 'huangro.laravel-payment.wechat.jsapi_ticket.';
